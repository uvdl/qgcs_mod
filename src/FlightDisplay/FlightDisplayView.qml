...
QGCView {
    ...
    QGCViewPanel {
        ...
        Loader {
            ...
            active:                     false //(_activeVehicle && _activeVehicle.active && QGroundControl.multiVehicleManager.activeVehicleAvailable && QGroundControl.multiVehicleManager.parameterReadyVehicleAvailable)
        ...
        Loader {
            ...
            height:                     _panel.height-uvdl.height-ScreenTools.toolbarHeight
            anchors.right:              _panel.right

            anchors.verticalCenter:     _panel.verticalCenter
